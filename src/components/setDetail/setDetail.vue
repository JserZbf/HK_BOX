						...
						<div class="blPadding">
							...
							<div class="setModule">
								...
								<div class="tableList" v-if="finishData && data.items.dew_point_c">
									...
									<!-- <div class="thList"><el-select v-model="data.items.dew_point_c.slaveId" placeholder="请选择编码"><el-option class="slTexts" v-for="item in slaveId" :key="item.value" :label="item.label"  :value="item.value"></el-option></el-select></div> -->
									<div class="thList">
										<el-input class="slTexts" type="text"
								...
								<div class="tableList" v-if="finishData && data.items.temperature">
									...
									<!-- <div class="thList"><el-select v-model="data.items.temperature.slaveId" placeholder="请选择编码"><el-option class="slTexts" v-for="item in slaveId" :key="item.value" :label="item.label"  :value="item.value"></el-option></el-select></div> -->
									<div class="thList">
										<el-input class="slTexts" type="text"
								...
								<div class="tableList" v-if="finishData && data.items.temperature2">
									...
									<!-- <div class="thList"><el-select v-model="data.items.temperature2.slaveId" placeholder="请选择编码"><el-option class="slTexts" v-for="item in slaveId" :key="item.value" :label="item.label"  :value="item.value"></el-option></el-select></div> -->
									<div class="thList">
										<el-input class="slTexts" type="text"
								...
								<div class="tableList" v-if="finishData && data.items.dif_pressure_pa">
									...
									<!-- <div class="thList"><el-select v-model="data.items.dif_pressure_pa.slaveId" placeholder="请选择编码"><el-option class="slTexts" v-for="item in slaveId" :key="item.value" :label="item.label"  :value="item.value"></el-option></el-select></div> -->
									<div class="thList">
										<el-input class="slTexts" type="text"
								...
								<div class="tableList" v-if="finishData && data.items.humidness">
									...
									<!-- <div class="thList"><el-select v-model="data.items.humidness.slaveId" placeholder="请选择编码"><el-option class="slTexts" v-for="item in slaveId" :key="item.value" :label="item.label"  :value="item.value"></el-option></el-select></div> -->
									<div class="thList">
										<el-input class="slTexts" type="text"
								...
								<div class="tableList" v-if="finishData && data.items.humidness2">
									...
									<!-- <div class="thList"><el-select v-model="data.items.humidness2.slaveId" placeholder="请选择编码"><el-option class="slTexts" v-for="item in slaveId" :key="item.value" :label="item.label"  :value="item.value"></el-option></el-select></div> -->
									<div class="thList">
										<el-input class="slTexts" type="text"
								...
								<div class="tableList" v-if="finishData && data.items.g05">
									...
									<!-- <div class="thList"><el-select v-model="data.items.g05.slaveId" placeholder="请选择编码"><el-option class="slTexts" v-for="item in slaveId" :key="item.value" :label="item.label"  :value="item.value"></el-option></el-select></div> -->
									<div class="thList">
										<el-input class="slTexts" type="text"
								...
								<div class="tableList" v-if="finishData && data.items.g50">
									...
									<!-- <div class="thList"><el-select v-model="data.items.g50.slaveId" placeholder="请选择编码"><el-option class="slTexts" v-for="item in slaveId" :key="item.value" :label="item.label"  :value="item.value"></el-option></el-select></div> -->
									<div class="thList">
										<el-input class="slTexts" type="text"
