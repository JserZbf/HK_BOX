<template>
              ...
              <div class="blPadding">
                ...
                <div class="setModule">
                  <div class="tableHeader">
                    ...
                    <!-- <div class="thList">是否模拟量转换</div> -->
                    <div class="thList">是否报警</div>
                    <!-- <div class="thList">操作</div> -->
                  </div>
                  <!-- finishData && data.items.g05 -->
                  <div
                    class="tableList"
                  ...
                  >
                    ...
                    <el-select v-model="item.conType" placeholder="选择采集类型">
                      <el-option
                        class="slTexts"
                    ...
                    <!-- <div class="thList"><el-select v-model="item.slaveId" placeholder="请选择编码"><el-option class="slTexts" v-for="item in slaveId" :key="item.value" :label="item.label"  :value="item.value"></el-option></el-select></div> -->
                    <div class="thList">
                      <el-input
                        class="slTexts"
                        type="text"
  ...
  .header-box {
    height: 130px;
    z-index: 800;
    background: url("/image/twoBg.png") no-repeat center top / cover;
  }
